About rpaframework-recognition
==============================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rpaframework-recognition-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11350&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rpaframework-recognition-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rpaframework-recognition` can be installed with:

```
conda install rpaframework-recognition
```

It is possible to list all of the versions of `rpaframework-recognition` available on your platform with:
